...
func TestExtractSecondLevelValue(t *testing.T) {
	jsonStr := `{
	...
	newJson, err := extractSecondLevelValue(jsonStr)
	assert.Nil(t, err)
	assert.Equal(t, newJson, newStr)
  ...
  "Error": {
	...
	jsonStr = `{"BodyConfiguration":{"StrField1":"StrField1","StrField2":"StrField2"}}`

	newStr = `{"StrField1":"StrField1","StrField2":"StrField2"}`
