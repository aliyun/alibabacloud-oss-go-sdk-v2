...
func TestResolveEndpoint(t *testing.T) {
	...
	updateEndpoint(cfg)
	assert.NotNil(t, cfg.Endpoint)
	assert.Equal(t, "test-region.oss-tables.aliyuncs.com", oss.ToString(cfg.Endpoint))
	...
	updateEndpoint(cfg)
	assert.NotNil(t, cfg.Endpoint)
	assert.Equal(t, "test-region-internal.oss-tables.aliyuncs.com", oss.ToString(cfg.Endpoint))
