...
func TestResolveEndpoint(t *testing.T) {
	...
	updateEndpoint(cfg)
	assert.NotNil(t, cfg.Endpoint)
	assert.Equal(t, "oss-test-region.oss-tables.aliyuncs.com", oss.ToString(cfg.Endpoint))
	...
	updateEndpoint(cfg)
	assert.NotNil(t, cfg.Endpoint)
	assert.Equal(t, "oss-test-region-internal.oss-tables.aliyuncs.com", oss.ToString(cfg.Endpoint))
...
func TestResolveTablesUserAgent(t *testing.T) {
	cfg := oss.NewConfig()
	updateUserAgent(cfg)
	assert.Equal(t, oss.ToString(cfg.UserAgent), "tables-client")

	cfg = oss.NewConfig()
	cfg.WithUserAgent("my-user-agent")
	updateUserAgent(cfg)
	assert.Equal(t, oss.ToString(cfg.UserAgent), "tables-client/my-user-agent")
}
