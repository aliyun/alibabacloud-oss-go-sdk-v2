...
func cleanBucket(bucketInfo TableBucketProperties, t *testing.T) {
	assert.NotEmpty(t, *bucketInfo.BucketArn)
	var c *TablesClient
	c = getDefaultClient()
	assert.NotNil(t, c)
	cleanTablesAndNamespaces(c, *bucketInfo.BucketArn, t)
}
