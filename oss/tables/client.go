...
func NewTablesClient(cfg *oss.Config, optFns ...func(*oss.Options)) *TablesClient {
	newCfg := cfg.Copy()
	...
	allOptFns := append(optFns, tablesOptFn)
	return &TablesClient{
...
func (c *TablesClient) marshalInput(request any, input *oss.OperationInput, handlers ...func(any, *oss.OperationInput) error) error {
	// merge common fields
...
// oss new api's style
func (c *TablesClient) marshalInputJson(request any, input *oss.OperationInput, handlers ...func(any, *oss.OperationInput) error) error {
	// merge common fields
	if cm, ok := request.(oss.RequestCommonInterface); ok {
		h, p, b := cm.GetCommonFileds()
		// headers
...
func (c *TablesClient) unmarshalOutput(result any, output *oss.OperationOutput, handlers ...func(any, *oss.OperationOutput) error) error {
	// Common
...
func (c *TablesClient) toClientError(err error, code string, output *oss.OperationOutput) error {
	if err == nil {
		return nil
	}
