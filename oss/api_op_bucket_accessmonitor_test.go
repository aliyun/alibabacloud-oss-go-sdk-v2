...
func TestMarshalInput_PutBucketAccessMonitor(t *testing.T) {
	c := Client{}
	assert.NotNil(t, c)
...
func TestMarshalInput_GetBucketAccessMonitor(t *testing.T) {
	c := Client{}
	assert.NotNil(t, c)
...
func TestUnmarshalOutput_GetBucketAccessMonitor(t *testing.T) {
	c := Client{}
	assert.NotNil(t, c)
	var output *OperationOutput
	var err error
...
<AccessMonitorConfiguration>
 <Status>Disabled</Status>
	...
	assert.Equal(t, result.Status, "OK")
	assert.Equal(t, result.Headers.Get("X-Oss-Request-Id"), "534B371674E88A4D8906****")
	assert.Equal(t, result.AccessMonitorConfiguration.Status, AccessMonitorStatusDisabled)
